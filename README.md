...
| `build.yml` | Пт 05:00 UTC, ручной | Полная сборка и публикация, включая custom `dae`; push-trigger отключён, чтобы обычные коммиты не запускали долгую OpenWrt-сборку |
